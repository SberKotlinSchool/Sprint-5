...
class JsonCustomNamingPropertyStrategyTest {
    ...
    companion object UpperCaseCustomStrategy: PropertyNamingStrategies.NamingBase() {
        override fun translate(p0: String?): String = p0?.uppercase() ?: ""
    }
    ...
    fun `Кастомная стратегия десериализации`() {
        ...
        val objectMapper = ObjectMapper()
            ...
            .setPropertyNamingStrategy(UpperCaseCustomStrategy)
