...
class JsonDeserializationTest {
    ...
    fun `Имена свойств совпадают`() {
        ...
        val objectMapper = ObjectMapper().registerModules(JavaTimeModule(), KotlinModule())
    ...
    fun `В JSON есть лишние свойства Настроить ObjectMapper`() {
        ...
        val objectMapper = ObjectMapper().registerModules(JavaTimeModule(), KotlinModule()).disable(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES)
    ...
    fun `Поддержка optional типа`() {
        ...
        val data1 =
            """{"firstName": "Иван", "lastName": "Иванов", "middleName": "Иванович", "passportNumber": "123456", "passportSerial": "1234", "birthDate": "1990-01-01"}"""
        val objectMapper = ObjectMapper().registerModules(JavaTimeModule(), KotlinModule(), Jdk8Module())
